...
`)), isWebstandard && ("GET" in methods || "ALL" in methods) && !("HEAD" in methods) && (switchMap += `case 'HEAD':const _ht=ht[${methods.GET ?? methods.ALL}].composed(c)
